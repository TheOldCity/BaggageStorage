...
namespace BaggageStorage.Data.Migrations
{
    ...
    [Migration("20180907141821_BaggageMoving")]
    partial class BaggageMoving
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaggageStorage.Data.Models.BaggageMoving", b =>
                {
                    ...
                    b.Property<string>("UserConnectionSessionId");
                    ...
                    b.HasIndex("UserConnectionSessionId");
            ...
            modelBuilder.Entity("BaggageStorage.Data.Models.BaggageMoving", b =>
                {
                    ...
                    b.HasOne("BaggageStorage.Data.Models.UserConnection", "UserConnection")
                        .WithMany("BaggageRecievings")
                        .HasForeignKey("UserConnectionSessionId");
                });
            ...
            modelBuilder.Entity("BaggageStorage.Data.Models.StoragePlace", b =>
                {
                    b.HasOne("BaggageStorage.Data.Models.BaggageMoving")
